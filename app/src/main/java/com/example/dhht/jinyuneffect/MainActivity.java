...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView iv_bg, ivShowPic;//iv_bg 是整个的底图  ivshouwpic是转动的图
    ObjectAnimator objectAnimator;//动画
    JinyunView jinyunView;//鲸云的效果


    private Visualizer visualizer; //Android 原生的音效控制器
    ...
    public void getBitmap() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Bitmap bitmap2 = Bitmap.createBitmap(iv_bg.getDrawingCache());//有时候需要将某个view的内容以图片的方式保存下来，感觉就和截图差不多，可以使用View 的getDrawingCache方法，返回一个Bitmap对象。
